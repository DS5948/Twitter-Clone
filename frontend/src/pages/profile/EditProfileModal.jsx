...
>
  ...
  <div className="relative">
    ...
    />
    <div
      className="block h-6 w-11 rounded-full bg-gray-300 cursor-pointer"
      onClick={handleTogglePrivate}
    >
		<div
      className={`cursor-pointer absolute h-6 w-6 transform rounded-full bg-white transition ${
        isPrivate ? "translate-x-5 bg-zinc-950" : "bg-gray-400"
      }`}
      onClick={handleTogglePrivate}
    ></div>
	</div>
