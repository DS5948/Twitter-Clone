			...
			<div className='flex-1 flex flex-col justify-center items-center'>
				<form className='flex gap-4 flex-col' onSubmit={handleSubmit}>
					...
					<label className='input input-bordered rounded flex items-center gap-2'>
						...
						<input
							type='text'
							className='bg-white grow border-b focus:border-b-2 border-black outline-none'
					...
					<label className='input input-bordered rounded flex items-center gap-2'>
						...
						<input
							type='password'
							className='bg-white border-b focus:border-b-2 border-black outline-none grow'
					...
					<button className='p-2 btn bg-black text-white rounded-full btn-primary'>
